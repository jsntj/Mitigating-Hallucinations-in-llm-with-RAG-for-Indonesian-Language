...
This script evaluates all questions from the IndoMMLU.csv file using multiple models.
"""
...
def format_prompt(question, choices):
    """Format pertanyaan dan pilihan dengan dorongan pemikiran singkat."""
    return f"""Pertanyaan berikut ini dalam bahasa Indonesia: {question}

Pilih jawaban dari pilihan berikut:
{choices}

Pikirkan langkah demi langkah: baca pertanyaan, pertimbangkan setiap opsi, lalu pilih jawaban terbaik.
Pada baris terakhir, berikan hanya huruf (A, B, C, D, atau E). Jawaban:"""
